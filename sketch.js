...
function draw() {
  ...
  if (gameState===PLAY){
    ...
    restart_btn = createSprite(400,200,50,50)
    restart_btn.addImage(restartImg)
     restart_btn.scale = 0.10
     if(mousePressedOver(restart_btn)){
       location.reload()
     }
     gameOver = createSprite(400,100,50,50)
     gameOver.addImage(gameOverImg);
     gameOverImg.scale = 0.10;
